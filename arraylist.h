...
/*
Templated ArrayList based on Assignment #1 Solution Code
*/
...
//    =============== 
 ...
 ArrayList<T> & s; 
 public: 
  ArrayListIterator(ArrayList<T> & set, int position = 0) : s(set), index(position){} 
  ArrayListIterator(const ArrayList<T> & set, int position = 0) : s( (ArrayList<T> &) set), index(position){} 
