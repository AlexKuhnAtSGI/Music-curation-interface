...
class MyTunes
{
  ...
  private:
	...
	void executeFollowPlaylist(Command cmd);
	void executeCeaseFollowing(Command cmd);
	//Two follow-class commands added to establish/maintain the proper subject-observer relationships
